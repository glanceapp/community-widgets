...
Live IP address, relative last seen timestamp, and key expiry for a specific Tailscale device.
...
- `TAILSCALE_TAILNET` - Your tailnet name (e.g. `example.org.github` or `user@gmail.com`)
- `TAILSCALE_API_KEY` - Your Tailscale API key
- `TAILSCALE_DEVICE_IP` - The specific 100.x.y.z IP address of the device you want to monitor
