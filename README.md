...
* [Netbird Peers Count](widgets/netbird-peers-count/README.md) - real-time total connected network peer count (by @kirolos-esmat)
...
* [caltask](https://github.com/benginN/caltask) - self-hosted calendar + tasks designed to embed in Glance as a fully interactive iframe widget (switch views, drag events, tick off tasks without leaving the dashboard) (by @benginN)
